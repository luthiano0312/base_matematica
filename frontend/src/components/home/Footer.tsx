      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul className="footer-nav-list">
              <li><a href="#termos" onClick={(e) => { e.preventDefault(); alert('Termos de Uso em breve.'); }}>Termos de Uso</a></li>
              <li><a href="#privacidade" onClick={(e) => { e.preventDefault(); alert('Política de Privacidade em breve.'); }}>Política de Privacidade</a></li>
            </ul>
          </div>
        </div>
