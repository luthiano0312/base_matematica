  ...
  return (
    <div className="questao-page">
      ...
      <header className="q-topbar">
        ...
        {/* Barra de progresso */}
        <ProgressBar now={q.posicao} min={1} max={q.total} />

        {/* Cards de estatísticas */}
        <div className="q-stats">
          <StatCard tone="blue" number={q.respondidas} label="respondidas" />
          <StatCard tone="green" number={q.acertos} label="acertos" />
          <StatCard tone="red" number={q.erros} label="erros" />
        </div>
      </header>
