          ...
          <div className="cadastro-form-login-container">
            <form className="cadastro-form" onSubmit={handleSubmit} noValidate>
              <div className="form-group">
                <label htmlFor="nome" className="form-label-cadastro">Nome</label>
                <input
                  id="nome"
                  name="nome"
                  type="text"
              ...
              <div className="form-group">
                <label htmlFor="email" className="form-label-cadastro">E-mail</label>
                <input
                  id="email"
                  name="email"
                  type="email"
              ...
              <div className="form-group">
                <label htmlFor="senha" className="form-label-cadastro">Senha</label>
                <div className="input-wrapper">
                  <input
                    id="senha"
                    name="senha"
                    type={mostrarSenha ? 'text' : 'password'}
                    className="form-input-cadastro form-input-with-action"
              ...
              <div className="form-group">
                <label htmlFor="confirmar-senha" className="form-label-cadastro">Confirmar senha</label>
                <div className="input-wrapper">
                  <input
                    id="confirmar-senha"
